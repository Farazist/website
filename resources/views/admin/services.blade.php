    ...
    <div class="col">
        <div class="card shadow rounded-lg border-0">
            <div class="card-header bg-transparent border-0">
                ...
                <a href="{{ URL::asset("/admin/service/add") }}" class="btn btn-success float-left">
            ...
            <div class="card-body">
                ...
                <br>
                @if(count($services) == 0)
                <h3 class="card-title">امکاناتی وجود ندارد</h3>
                @else
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover small">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                <td>
                                    <img class="img-fluid rounded" src="{{ URL::asset("$service->image") }}">
                                </td>
                                <td class="align-middle">{{$service->title}}</td>
                                <td class="align-middle">{{$service->caption}}</td>

                                <td class="align-middle text-left">
                                    <a href="{{ URL::asset("/admin/service/edit/$service->id") }}"
                                        class="btn-outline-info btn btn-sm">
                                        <span class="fas fa-pen fa-fw"></span>
                                    </a>
                                    <button type="button" data-toggle="modal" data-target="#deleteModal"
                                        data-id="{{$service->id}}" class="btn-outline-danger btn btn-sm">
...
<script>
    $('#deleteModal').on('show.bs.modal', function (event) {
        ...
        btn_delete.attr("href", '{{ URL::asset("/admin/service/delete") }}' + '/' + id);
    })
</script>
@endsection